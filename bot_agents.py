"""Optional Cursor Cloud Agents commands — preserved for backward compatibility.

Enabled only when ENABLE_CURSOR_AGENTS=true.
"""
...
logger = logging.getLogger("bot_agents")
...
def authorized(update: Update) -> bool:
    from ce_vault.handlers import authorized as vault_auth

    return vault_auth(update)
