"""Legacy Cursor Cloud Agents Telegram bot (backward compatibility).

Enable with LEGACY_CURSOR_BOT=1 python bot.py
"""
...
logger = logging.getLogger("cursor_bot")
...
def main() -> None:
    ...
    logger.info("legacy cursor bot starting (polling)")
